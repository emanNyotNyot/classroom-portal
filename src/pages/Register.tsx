...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ name, email, password, role, address, class_name: className }),
      });
  ...
  return (
    <div className="flex min-h-[calc(100vh-73px)] items-center justify-center bg-zinc-950 p-4 py-12">
      <motion.div
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  ...
                  className={role === 'student' ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'border-zinc-700 text-zinc-300 hover:bg-zinc-800'}
                >
                  Student
                </Button>
                <Button
                  ...
                  className={role === 'lecturer' ? 'bg-indigo-600 hover:bg-indigo-700 text-white' : 'border-zinc-700 text-zinc-300 hover:bg-zinc-800'}
                >
                  Lecturer
                </Button>
              </div>
